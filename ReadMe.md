...
Click this [link](https://www.kaggle.com/datasets/tonygordonjr/spotify-dataset/data) if you want to see the final result of what you could pontentially have.  I uploaded a version of my table to Kaggle.
